dir = getDirectory("image"); 
  ...
  channel2_name = "C2-MAX_"+name; //647-SiR-DNA
  channel3_name = "C3-MAX_"+name; //TPMT
  channel4_name = "C4-MAX_"+name; //mBFP-mock or DN-KASH
...
//threshold using euchromatin channel and create a Mask file
...
String.copyResults();
waitForUser("Paste mBFP values to excel and press OK, or cancel to exit");
