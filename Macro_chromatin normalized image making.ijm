dir = getDirectory("image"); 
  ...
  channel3_name = "C3-"+name; //DAPI
  channel3_max_name = "MAX_C3-"+name;
  channel4_name = "C4-"+name; //heterochromatin

run("Split Channels");
selectWindow(channel1_name);
run("Macro...", "code=[if (v>=0 && v<=1) v=1] stack");
imageCalculator("Divide create 32-bit stack", channel4_name, channel1_name);
...
imageCalculator("Multiply", name2_2, channel3_max_name);
